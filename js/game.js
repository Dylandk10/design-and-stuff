...
class Game_Handler {
     ...
     **/
    checkKeyCode() {
        if (myGameArea.key === 'Space' && myGameArea.spaceBar == true) {
            this.spawnBullet();
            player.speedX = -5;
        } else if (myGameArea.key === 'ArrowRight' && myGameArea.spaceBar == true) {
            this.spawnBullet();
            player.speedX = 5;
        } else if (myGameArea.key === 'ArrowUp' && myGameArea.spaceBar == true) {
            this.spawnBullet();
            player.speedY = -5;
        } else if (myGameArea.key === 'ArrowDown' && myGameArea.spaceBar == true) {
            this.spawnBullet();
            player.speedY = 5;
        } else if (myGameArea.key === 'ArrowLeft') {
            player.speedX = -5;
        } else if (myGameArea.key === 'ArrowRight') {
            player.speedX = 5;
        } else if (myGameArea.key === 'ArrowUp') {
            player.speedY = -5;
        } else if (myGameArea.key === 'ArrowDown') {
            player.speedY = 5;
